	...
	return (
		<main className="container mx-auto px-4 py-16 max-w-3xl">
			<header className="mb-12">
				<h1 className="text-4xl font-bold mb-3">{t('page.terms.of.service')}</h1>
			...
			<div className="prose prose-headings:text-base-content prose-p:text-base-content/80 prose-li:text-base-content/80 prose-a:text-primary max-w-none">
				...
				<p>
					...
					<a href={`/${locale}/privacy`}>Privacy Policy</a> and{' '}
					<a href={`/${locale}/cookies`}>Cookie Policy</a>, which are
				...
				<h2>4. Services and Consulting</h2>
				<p>
