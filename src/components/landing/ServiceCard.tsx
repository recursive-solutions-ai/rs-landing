	...
	function ServiceCard({ service, index }, ref) {
		...
		return (
			...
			>
				...
				<a
					href="#contact"
					className="mt-auto pt-4 flex items-center gap-1.5 text-sm font-semibold opacity-0 translate-y-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0"
