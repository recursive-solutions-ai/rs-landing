...
export function checkEnv(): void {
	...
	const optionalGroups: EnvGroup[] = [
		{
			...
			impact: 'sitemap.xml and robots.txt will use localhost defaults',
		},
		{
	...
	if (additionalLanguages) {
		info.push(`[i18n] DEFAULT_LANGUAGE=${defaultLanguage}, additional: ${additionalLanguages}`)
	} else {
